            ...
            <div class="mbr-section__col col-xs-12 col-sm-6">
                ...
                <div class="mbr-section__container mbr-section__container--middle">
                    <div class="mbr-article mbr-article--wysiwyg">
                        <p>Here the students can play, compete quiz competitions. Go and explore your talent!<br><span style='color:blue'>Note:</span> <small>please Login Before continue!</small></p>
                    </div>
                </div>
                <div class="mbr-section__container mbr-section__container--last" style="padding-bottom: 93px;">
                    <div class="mbr-buttons mbr-buttons--center"><a href="play.php" class="mbr-buttons__btn btn btn-wrap btn-xs-lg btn-danger">PLAY QUIZS</a></div>
                </div>
            </div>
            <div class="mbr-section__col col-xs-12 col-sm-6">
                <div class="mbr-section__container mbr-section__container--center mbr-section__container--middle">
                ...
                <div class="mbr-section__container mbr-section__container--middle">
                    <div class="mbr-article mbr-article--wysiwyg">
                        <p>Here the faculties can upload question for the quiz, with their respective answers. Upload qustion now!<br><span style='color:blue'>Note:</span> <small>please Login Before continue!</small></p>
                    </div>
                </div>
                <div class="mbr-section__container mbr-section__container--last" style="padding-bottom: 93px;">
                    <div class="mbr-buttons mbr-buttons--center"><a href="upload_client.php" class="mbr-buttons__btn btn btn-wrap btn-xs-lg btn-danger">UPLOAD NOW</a></div>
                </div>
              </div>
            </div>
          </div>
